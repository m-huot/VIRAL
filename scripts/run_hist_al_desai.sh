...
#SBATCH -o desai_outfile_hist  # send stdout to outfile (with job ID)
#SBATCH -e desai_errfile_hist  # send stderr to errfile (with job ID)
...
python3 hist_al_desai.py --embed "$embed"
